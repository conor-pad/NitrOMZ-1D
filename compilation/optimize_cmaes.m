 ...
 %-----------------
 % Optimization names
 OptName = 'Opt_Nov_v3_nir';
 OptNameLong = 'Fix oxic/phys, vary anoxic params., vary Ji, non-interpolated tracers (with NH4) + random noise at 0.1, 4 rates, 20k max. ev.';
...
%file_tracr = 'compilation_ETSP_gridded_Feb232018.mat'; 
 ...
 inoise = 1; 	% 1 will add some noise to the data files, to introduce i
             	% a small random elelment to the data optimization
 %-----------------
