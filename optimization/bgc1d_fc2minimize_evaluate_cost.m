...
%tmp = load([bgc.root,'/Data/compilation_ETSP_gridded_Feb232018_interpol.mat']);
 ...
 tmp = load(['comprates_ETSP_local.mat']);
...
%Data.weights =  	[2    1     0     1     8     0     4     0    4];	% Anoxic Optimization-2
 Data.weights =  	[2    1     0     1     8     2     4     0    4];	% Anoxic Optimization-3: includes NH4
