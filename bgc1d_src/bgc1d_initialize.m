...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%% User specific  %%%%%%%%%
 bgc.root = '/Users/conor/Library/Mobile Documents/com~apple~CloudDocs/UCLA/share_kelly_230822/'; 
 ...
 bgc.rest_verbose = false; % prompts a message when loading restart
